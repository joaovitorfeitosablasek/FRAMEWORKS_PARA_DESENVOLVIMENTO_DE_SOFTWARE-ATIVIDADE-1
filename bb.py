...
def anuncio():
    return render_template('anuncio.html', titulo="Cadastro de Novo Produto")

@app.route("/config/categoria")
def categoria():
    return render_template('categoria.html', titulo="Todas Categorias")
...
def relCompras():
    return render_template('relCompras.html', titulo="Relatorio de Compras")